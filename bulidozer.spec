...
requirements = python3,kivy==2.3.0,requests,openpyxl,plyer,firebase-admin,cryptography,pyjnius
...
# (bool) Copies library instead of making a libpymodules.so
#android.copy_libs = 1
...
# Run `buildozer android list` to see all available bootstraps.
p4a.bootstrap = sdl2
